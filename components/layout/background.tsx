...
export default function Background() {
  return (
    <div className="absolute inset-0 h-[102%] overflow-hidden -z-10">
      ...
      <div className="absolute inset-0 md:bg-[radial-gradient(ellipse_45%_15%_at_50%_50%,var(--accent)_0%,transparent_70%)] bg-[radial-gradient(ellipse_200%_15%_at_60%_50%,var(--accent)_0%,transparent_70%)] opacity-40" />
